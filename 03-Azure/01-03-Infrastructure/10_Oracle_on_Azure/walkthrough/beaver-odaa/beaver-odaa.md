...
>  **IMPORTANT**: In case you are using an Azure Network Security Group (NSG) make sure your client IP is whitelisted to access the AKS where Beaver is running.
...
3.  Select the cloud icon on the upper left corner.
4. ➕ Select "New Connection"
5. 🔶 Select Oracle
6.  Select Configuration option "URL" instead of "Manual"
...
2. 🔶 Select Oracle
3.  Select Configuration option "URL" instead of "Manual"
